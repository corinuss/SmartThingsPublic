 ...
 *
 *  ewill 02/24/2018
 *  Exactly the same as the original "ZigBee Dimmer Power" without the run locally flag.  For some reason this allows
 *  a setLevel() call from Off to turn on the lights at the correct value (rather than maximum).
 */

metadata {
    definition (name: "Fixed ZigBee Dimmer Power", namespace: "corinuss", author: "Eric Will", ocfDeviceType: "oic.d.light", minHubCoreVersion: '000.019.00012', executeCommandsLocally: true) {
        capability "Actuator"
...
//	zigbee.command(0x0008, 0x01, "32", "0001")
}
